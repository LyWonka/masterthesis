...
if __name__ == "__main__":
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value = 0.00043479783929999995 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value = 0.002014296014 # TODO np.mean(measures_power_meter_path2)
    #faktor = power_meter_ref_value / power_meter_path2_value
    faktor = 4.632718546262565 # TODO power_meter_path2_value / power_meter_ref_value
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_do = 2.588407346e-06 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.0004329069721 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value1 = np.mean(measures_power_meter_path2)
    iso_do1 = 0.0012610003311780004 # TODO(power_meter_path2_value1 / (power_meter_ref_value1 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0004345092545 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value2 = np.mean(measures_power_meter_path2)
    iso_do2 = 1.000664162608762 # TODO (power_meter_path2_value2 / (power_meter_ref_value2 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.00043269456069999995 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value1 = 0.0015205267239999998 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0004318310763 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value2 = 3.280054225e-05 # TODO np.mean(measures_power_meter_path2)
