...
if __name__ == "__main__":
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value = 0.0005373605003000002 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value = 0.002493677729 # TODO np.mean(measures_power_meter_path2)
    #faktor = power_meter_ref_value / power_meter_path2_value
    faktor = 4.640604822289353 # TODO power_meter_path2_value / power_meter_ref_value
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_do = 0.002351779305 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.0005445777262999999 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value1 = np.mean(measures_power_meter_path2)
    iso_do1 = 0.9394839613478131 # TODO(power_meter_path2_value1 / (power_meter_ref_value1 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0005422666611000001 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value2 = np.mean(measures_power_meter_path2)
    iso_do2 = 0.9909524941289075 # TODO (power_meter_path2_value2 / (power_meter_ref_value2 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.0005431278316 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value1 = 0.002368962507 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0005481355475 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value2 = 5.880360150999999e-05 # TODO np.mean(measures_power_meter_path2)
