...
if __name__ == "__main__":
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value = 0.00048277647579999996 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value = 0.0012415029810000002 # TODO np.mean(measures_power_meter_path2)
    #faktor = power_meter_ref_value / power_meter_path2_value
    faktor = 2.5715896346082907 # TODO power_meter_path2_value / power_meter_ref_value
    ...
    # #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    # #     measures_power_meter_path2.append(power.value)
    # power_do = 0.0008519360096 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.0004836722628 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value1 = np.mean(measures_power_meter_path2)
    iso_do1 = 1.0 # TODO(power_meter_path2_value1 / (power_meter_ref_value1 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0004817236857 # TODO np.mean(measures_power_meter_ref)
    # power_meter_path2_value2 = np.mean(measures_power_meter_path2)
    iso_do2 = 1.0 # TODO (power_meter_path2_value2 / (power_meter_ref_value2 * faktor))
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value1 = 0.00047928330599999997 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value1 = 0.0005934321437 # TODO np.mean(measures_power_meter_path2)
    ...
    #     lib.TLPMX_measPower(power_meter_path2, byref(power), 1)
    #     measures_power_meter_path2.append(power.value)
    power_meter_ref_value2 = 0.0004758201335 # TODO np.mean(measures_power_meter_ref)
    power_meter_path2_value2 = 0.0001605871161 # TODO np.mean(measures_power_meter_path2)
